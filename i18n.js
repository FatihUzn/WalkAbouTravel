...
const translations = {
    ...
    ru: {
        ...
        filter_all_routes: "ВСЕ МАРШРУТЫ",
        filter_turkey: "Маршруты по Турции",
        filter_international: "Международные туры",
        filter_daily: "Однодневные туры",
        filter_group: "Групповые туры",
        tour_detail_btn: "ПОДРОБНЕЕ",
        tour_no_desc: "Описание отсутствует.",
        tour_duration_default: "7 Дней",
        read_more: "Читать далее",
        err_404_title: "Потеряли маршрут?",
        err_404_desc: "Страница, которую вы ищете, могла быть перемещена, удалена или никогда не существовала. Вернитесь на главную страницу.",
        err_404_btn: "На главную",
        alert_enter_name: "Пожалуйста, введите ваше имя.",
        alert_enter_email: "Пожалуйста, введите ваш email.",
        alert_invalid_email: "Пожалуйста, введите действительный email.",
        alert_enter_message: "Пожалуйста, введите ваше сообщение.",
        alert_sending: "Ваше сообщение отправляется через WhatsApp...",
        wa_contact_intro: "Здравствуйте! Пишу с вашего сайта.",
        wa_contact_name: "Имя",
        wa_contact_email: "Email",
        wa_contact_phone: "Телефон",
        wa_contact_message: "Сообщение",
        wa_tour_inquiry: "Здравствуйте, я хотел бы узнать о туре \"{title}\".",
        wa_blog_inquiry: "Здравствуйте, я прочитал вашу статью \"{title}\" и хотел бы получить дополнительную информацию.",
        loading: "Загрузка...",
        loading_blog: "Загрузка статьи, пожалуйста, подождите...",
    ...
    de: {
        ...
        filter_all_routes: "ALLE ROUTEN",
        filter_turkey: "Türkei-Routen",
        filter_international: "Internationale Touren",
        filter_daily: "Tagestouren",
        filter_group: "Gruppentouren",
        tour_detail_btn: "DETAILS ANSEHEN",
        tour_no_desc: "Keine Beschreibung verfügbar.",
        tour_duration_default: "7 Tage",
        read_more: "Weiterlesen",
        err_404_title: "Route verloren?",
        err_404_desc: "Die gesuchte Seite wurde möglicherweise verschoben, gelöscht oder existierte nie. Kehren Sie zur Startseite zurück.",
        err_404_btn: "Zur Startseite",
        alert_enter_name: "Bitte geben Sie Ihren Namen ein.",
        alert_enter_email: "Bitte geben Sie Ihre E-Mail-Adresse ein.",
        alert_invalid_email: "Bitte geben Sie eine gültige E-Mail-Adresse ein.",
        alert_enter_message: "Bitte geben Sie Ihre Nachricht ein.",
        alert_sending: "Ihre Nachricht wird über WhatsApp gesendet...",
        wa_contact_intro: "Hallo! Ich melde mich von Ihrer Website.",
        wa_contact_name: "Name",
        wa_contact_email: "E-Mail",
        wa_contact_phone: "Telefon",
        wa_contact_message: "Nachricht",
        wa_tour_inquiry: "Hallo, ich möchte Informationen über die Tour \"{title}\" erhalten.",
        wa_blog_inquiry: "Hallo, ich habe Ihren Artikel \"{title}\" gelesen und möchte weitere Informationen.",
        loading: "Lädt...",
        loading_blog: "Blogbeitrag wird geladen, bitte warten...",
    ...
    zh: {
        ...
        filter_all_routes: "所有路线",
        filter_turkey: "土耳其路线",
        filter_international: "国际旅游",
        filter_daily: "一日游",
        filter_group: "团体旅游",
        tour_detail_btn: "查看详情",
        tour_no_desc: "暂无描述。",
        tour_duration_default: "7天",
        read_more: "阅读更多",
        err_404_title: "迷路了？",
        err_404_desc: "您要找的页面可能已移动、删除或从未存在。请返回主页。",
        err_404_btn: "返回主页",
        alert_enter_name: "请输入您的姓名。",
        alert_enter_email: "请输入您的电子邮件。",
        alert_invalid_email: "请输入有效的电子邮件地址。",
        alert_enter_message: "请输入您的留言。",
        alert_sending: "您的消息正在通过WhatsApp发送...",
        wa_contact_intro: "您好！我从您的网站联系您。",
        wa_contact_name: "姓名",
        wa_contact_email: "电子邮件",
        wa_contact_phone: "电话",
        wa_contact_message: "留言",
        wa_tour_inquiry: "您好，我想了解\"{title}\"旅游的详情。",
        wa_blog_inquiry: "您好，我读了您网站上的\"{title}\"文章，想了解更多信息。",
        loading: "加载中...",
        loading_blog: "正在加载博客文章，请稍候...",
        breadcrumb_home: "首页",
        breadcrumb_blog: "博客"
    },
